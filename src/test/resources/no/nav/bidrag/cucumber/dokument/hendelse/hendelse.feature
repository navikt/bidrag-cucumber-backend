# language: no
@bidrag-dokument-hendelse
Egenskap: bidrag-dokument-hendelse

  Tester REST API til endepunkt i bidrag-dokument-hendelse.
  ...
  Fasit environment er gitt ved environment variabler ved oppstart.
    ...
    Og resttjenesten 'bidragDokumentHendelse'
