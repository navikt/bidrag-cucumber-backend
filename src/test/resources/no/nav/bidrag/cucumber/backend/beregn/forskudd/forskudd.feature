...
Egenskap: bidrag-beregn-forskudd-rest
  ...
  Scenario:
    ...
    Så skal http status være '200'
    Og responsen skal inneholde beløpet '2090' under stien '$.resultatPeriodeListe[0].resultatBeregning.resultatBelop'
    Og responsen skal inneholde resultatkoden 'FORHOYET_FORSKUDD_11_AAR_125_PROSENT' under stien '$.resultatPeriodeListe[0].resultatBeregning.resultatKode'
