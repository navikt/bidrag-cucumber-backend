...
open class RestTjeneste(
    ...
    protected fun httpEntity(endpointUrl: String): HttpEntity<String> {
    ...
    protected fun exchange(jsonEntity: HttpEntity<String>, endpointUrl: String, httpMethod: HttpMethod) {
        try {
