...
class SakEgenskap {
    ...
    @Og("bruk av en produksjonsbrukeren {string} med tilgang til bidrag-sak pip")
    fun `bruk av en produksjonsbruker med tilgang til bidrag sak pip`(pipUser: String) {
        SakEgenskap.pipUser = pipUser
